...
public class WatsonSDK350_Services : MonoBehaviour
{
    ...
    //STT_Article service created in Frankfurt
    //TTS_Article service created in Frankfurt
    ...
    private IEnumerator CreateTTSService()
    {
        ...
        {
            throw new WatsonException("Please provide IAM apikey to authenticate the TTS service.");
        }
    ...
    private IEnumerator CreateSTTService()
    {
        ...
        {
            throw new WatsonException("Please provide  IAM apikey to authenticate the STT service.");
        }
    ...
    private IEnumerator CreateASSService()
    {
        ...
        {
            throw new WatsonException("Please provide IAM apikey to authenticate the ASSISTANT service.");
        }
...
//    private void OnSTTRecognize(SpeechRecognitionEvent result, Dictionary<string, object> customData)
    // and put back to this way for 3.5.0 compatability!
